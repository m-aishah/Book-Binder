...
class LoginPage:
    def __init__(self, window):
        ...
        # ============================background image============================
        # ========================================================================
        self.bg_frame = Image.open('./images/library_background2.jpg')
        ...
        # ============ Left Side Image ================================================
        # ========================================================================
        self.side_image = Image.open('./images/bookshelf.jpeg')
        ...
        # ============ Sign In Image =============================================
        # ========================================================================
        self.sign_in_image = Image.open('./images/1_8.png')
        ...
        # ===== Username icon =========
        self.username_icon = Image.open('./images/1_8.png')
        ...
        # ============================login button================================
        # ========================================================================
        self.lgn_button = Image.open('./images/1_8.png')
        ...
        self.signup_img = ImageTk.PhotoImage(file='./images/1_8.png')
        ...
        # ======== Password icon ================
        self.password_icon = Image.open('./images/1_8.png')
